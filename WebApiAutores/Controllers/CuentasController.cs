...
namespace WebApiAutores.Controllers
{
    ...
    public class CuentasController : ControllerBase
    {
        ...
        public ActionResult RealizarHash(string textoPlano)
        {
            ...
            var resultaddo2 = hashService.Hash(textoPlano);
        ...
        [HttpPost("registrar")] //api/cuentas/registar
        ...
        public async Task<ActionResult<RespuestaAutenticacion>> Login(CredencialesUsuario credencialesUsuario)
        {
            ...
            {
                return BadRequest("Login Incorerecto");
            }
        }
        ...
        public async Task<ActionResult<RespuestaAutenticacion>> Renovar()
        {
            ...
            var crdencialesUsuario = new CredencialesUsuario()
            {
                Email = email
            };
            return await ConstruirToken(crdencialesUsuario);
        }
